...
<meta names="apple-mobile-web-app-status-bar-style" content="black-translucent" />
		...
		<meta charset="UTF-8">
		<!-- Site Title -->
		<title>Draw-A-Person Test</title>
				...
				<div class="container">
						<div class="row fullscreen align-items-center justify-content-center">
							<div class="banner-content col-lg-6 col-md-12">
										<img src="img/ionic3-ico.png" alt="logo" height="30%" width ="30%"><br>
								...
								<center>
								<input type="text" class="form-control" style="width:40%;" placeholder="Username">
								
								<input type="text" class="form-control" style="width:40%;" placeholder="Password"></center>
								<a href="dashboard.php" class="primary-btn2 mt-20 text-uppercase ">Sign In<span class="lnr lnr-arrow-right"></span></a>
								<br>
